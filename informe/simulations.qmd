...
for (result, method) in [
    ...
    (circle_noise_results, "Circunferencia uniforme con ruido"),
    (circle_outliers_results, "Circunferencia uniforme con datos atípicos"),
    (circle_gauss_results, "Circunferencia Gaussiana"),
    (circle_gauss_noise_results, "Circunferencia Gaussiana con ruido"),
    (circle_gauss_outliers_results, "Circunferencia Gaussiana con datos atípicos"),
    (eyeglasses_results, "Anteojos"),
    (eyeglasses_noise_results, "Anteojos con ruido"),
    (eyeglasses_outliers_results, "Anteojos con datos atípicos"),
]:
