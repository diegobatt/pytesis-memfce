...
#| fig-cap: Conjunto de datos e intervalos de confianza obtenidos para el jugador identificado como el número 2, que corresponde al comportamiento de un defensor central
...
#| fig-cap: Conjunto de datos e intervalos de confianza obtenidos para el jugador identificado como el número 8, que corresponde al comportamiento de un lateral izquierdo
intervals_football = run_all_intervals(
    football_X_tag_8,
    h=h_football,
    robust_quantile=robust_quantile_football,
