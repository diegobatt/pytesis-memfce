...
## Intervalos de confianza para diagramas de persistencia {#sec-homologia-intervalos}

Resulta natural preguntarse cómo se aplican los intervalos de confianza, desarrollados en la @sec-intro-intervalos, a los diagramas de persistencia introducidos en la  @sec-intro-diagramas-persistencia. En este caso, no es un parámetro de una distribución sobre el cual se busca obtener una estimación del intervalo de confianza, sino de las cualidades topológicas de la variedad $\mathcal{M}$ del que provienen nuestros datos. Para lograr esto se busca, dado un nivel $1 - \alpha$, encontrar el estadístico $\theta_n$ tal que
